...
android {
    namespace = "com.litobumba.translator_kmm.android"
    compileSdk = 33
    defaultConfig {
        applicationId = "com.litobumba.translator_kmm.android"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.litobumba.translator_kmm.TestHiltRunner"
    }
    buildFeatures {
        compose = true
    }
